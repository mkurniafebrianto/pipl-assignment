...
public class TestAttendance {
        ...
        public static Collection<Object[]> data() {
                return Arrays.asList(new Object[][] {
                                { "Presensi Masuk Tepat di Batas Awal", LocalTime.of(6, 0, 0), true,
                                ...
                                { "Presensi Masuk Dalam Rentang Waktu yang Diperbolehkan", LocalTime.of(8, 0, 0), true,
                                                "presensi masuk berhasil dan kamu tepat waktu, MANTAB!" },
                                { "Presensi Masuk Tepat di Batas Akhir ", LocalTime.of(8, 30, 0), true,
                                                "presensi masuk berhasil dan kamu tepat waktu, MANTAB!" },
                                { "Presensi Masuk Tepat Setelah Batas Akhir ", LocalTime.of(8, 30, 1), true,
                                                "presensi masuk berhasil tapi sayang kamu terlambat" },
                                { "Presensi Masuk Tepat di Batas Akhir Toleransi", LocalTime.of(9, 0, 0), true,
                                                "presensi masuk berhasil tapi sayang kamu terlambat" },
                                { "Presensi Masuk Di Luar Batas Waktu Toleransi ", LocalTime.of(9, 0, 1), true,
                                                "maaf presensi masuk gagal karena diluar waktu yang ditentukan" },

                                { "Presensi Keluar Tepat di Batas Awal", LocalTime.of(16, 30, 0), false,
                                                "presensi keluar berhasil, pulang pulang!" },
                                { "Presensi Keluar Dalam Rentang Waktu yang Diperbolehkan", LocalTime.of(16, 45, 0),
                                                false,
                                                "presensi keluar berhasil, pulang pulang!" },
                                { "Presensi Keluar Tepat di Batas Akhir ", LocalTime.of(17, 0, 0), false,
                                                "presensi keluar berhasil, pulang pulang!" },
                                { "Presensi Keluar Tepat Setelah Batas Akhir ", LocalTime.of(17, 0, 1), false,
